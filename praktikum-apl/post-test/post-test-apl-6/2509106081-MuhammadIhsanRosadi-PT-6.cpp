...
void tampilkanDetailProyek(Project *project) {
    ...
    cout << "Judul     : " << project -> judul << endl;
    cout << "Deskripsi : " << project -> detail.deskripsi << endl;
    cout << "Software  : " << project -> detail.software << endl;
    cout << "Deadline  : " << project -> detail.deadline << endl;
    cout << "Klien     : " << project -> detail.klien << endl;
    cout << "Status    : " << project -> detail.status << endl;
    cout << "Komentar  : ";
