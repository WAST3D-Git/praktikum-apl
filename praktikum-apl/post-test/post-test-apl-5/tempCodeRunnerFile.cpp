...
const int MAX_KOMENTAR = 10;

struct Project{
    int id;  // Field ID yang ditambahkan
    string judul;
...
// ============ QUICK SORT UNTUK NAMA (ASCENDING) ============
int partitionNama(Project *projects, int low, int high) {
    string pivot = projects[high].judul;
    int i = low - 1;
...
void quickSortNama(Project *projects, int low, int high) {
    if(low < high) {
        int pi = partitionNama(projects, low, high);
        quickSortNama(projects, low, pi - 1);
        quickSortNama(projects, pi + 1, high);
    }
}

// ============ INSERTION SORT UNTUK ID (DESCENDING) ============
void insertionSortIDDescending(Project *projects, int n) {
    for(int i = 1; i < n; i++) {
...
// ============ MERGE SORT UNTUK STATUS (ASCENDING) ============
...
// Fungsi baru untuk menampilkan proyek dengan pilihan sorting
void tampilkanProyekDenganSorting(Project *projects, int jumlahProject, Project *originalProjects) {
    ...
    do {
        ...
        cout << "1. Sorting Nama (Ascending A-Z) - Quick Sort\n";
        cout << "2. Sorting ID (Descending) - Insertion Sort\n";
        cout << "3. Sorting Status (Ascending) - Merge Sort\n";
        cout << "4. Keluar (kembali ke menu)\n";
        ...
        switch(pilihanSorting) {
            case 1:
                quickSortNama(tempProjects, 0, jumlahProject - 1);
                cout << "\nData telah diurutkan berdasarkan NAMA (Ascending) menggunakan Quick Sort!\n";
                system("pause");
                break;
            case 2:
                insertionSortIDDescending(tempProjects, jumlahProject);
                cout << "\nData telah diurutkan berdasarkan ID (Descending) menggunakan Insertion Sort!\n";
                system("pause");
                break;
            case 3:
                mergeSortStatus(tempProjects, 0, jumlahProject - 1);
                cout << "\nData telah diurutkan berdasarkan STATUS (Ascending) menggunakan Merge Sort!\n";
                system("pause");
                break;
            case 4:
